...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=6E6E6E&center=true&vCenter=true&width=720&lines=%C2%A0Shipping+production+RAG+%26+agentic+systems+on+AWS+%2F+Azure;%C2%A0ReAct+agents+%C2%B7+multi-model+CV+pipelines+%C2%B7+event-driven+MLOps" alt="Typing SVG" />
...
I build the parts of AI systems that break in production, not just in notebooks — agent loops that need memory and fallback logic, retrieval pipelines that need to be cheap enough to actually deploy, and CV inference that has to run in real time. Currently splitting time between agentic LLM apps and real-time computer vision, both shipped end-to-end on AWS/Azure.
...
![RF--DETR](https://img.shields.io/badge/-RF--DETR-111F68?style=flat-square)
![DeepLabV3](https://img.shields.io/badge/-DeepLabV3-111F68?style=flat-square)
![ByteTrack](https://img.shields.io/badge/-ByteTrack-111F68?style=flat-square)
...
![Modal](https://img.shields.io/badge/-Modal_Labs-000000?style=flat-square)
...
<div align="center">
<sub>Open to Applied AI / LLM Engineering roles — reach out via <a href="mailto:saimmehmood2004@gmail.com">email</a> or <a href="https://www.linkedin.com/in/saim-mahmood-1385a5250/">LinkedIn</a>.</sub>
</div>
